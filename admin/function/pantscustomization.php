...
if(isset($_REQUEST['delall'])) {
	...
	$del_sql="DELETE FROM pantcustomization WHERE `pantcustomizationid` = '".$_REQUEST['delall']."'";  //die();
...
//	---------------------------------------------------------------///
		case 'fit_slimfit_narrow_front':
			$name = $result_image[0]['fit_slimfit_narrow_front'];
			$field_name = 'fit_slimfit_narrow_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'fit_slimfit_stright_front':
			$name = $result_image[0]['fit_slimfit_stright_front'];
			$field_name = 'fit_slimfit_stright_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'fit_slimfit_bellbottom_front':
			$name = $result_image[0]['fit_slimfit_bellbottom_front'];
			$field_name = 'fit_slimfit_bellbottom_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
...
//	---------------------------------------------------------------///
		...
		case 'fit_slimfit_narrow_back':
			$name = $result_image[0]['fit_slimfit_narrow_back'];
			$field_name = 'fit_slimfit_narrow_back';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'fit_slimfit_stright_back':
			$name = $result_image[0]['fit_slimfit_stright_back'];
			$field_name = 'fit_slimfit_stright_back';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'fit_slimfit_bellbottom_back':
			$name = $result_image[0]['fit_slimfit_bellbottom_back'];
			$field_name = 'fit_slimfit_bellbottom_back';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
...
//	---------------------------------------------------------------///
		...
		case 'fit_normalfit_narrow_front':
			$name = $result_image[0]['fit_normalfit_narrow_front'];
			$field_name = 'fit_normalfit_narrow_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'fit_normalfit_stright_front':
			$name = $result_image[0]['fit_normalfit_stright_front'];
			$field_name = 'fit_normalfit_stright_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'fit_normalfit_bellbottom_front':
			$name = $result_image[0]['fit_normalfit_bellbottom_front'];
			$field_name = 'fit_normalfit_bellbottom_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
...
//	---------------------------------------------------------------///
		...
		case 'fit_normalfit_narrow_back':
			$name = $result_image[0]['fit_normalfit_narrow_back'];
			$field_name = 'fit_normalfit_narrow_back';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'fit_normalfit_stright_back':
			$name = $result_image[0]['fit_normalfit_stright_back'];
			$field_name = 'fit_normalfit_stright_back';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'fit_normalfit_bellbottom_back':
			$name = $result_image[0]['fit_normalfit_bellbottom_back'];
			$field_name = 'fit_normalfit_bellbottom_back';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
...
//	---------------------------------------------------------------///
		...
		case 'fit_loosefit_narrow_front':
			$name = $result_image[0]['fit_loosefit_narrow_front'];
			$field_name = 'fit_loosefit_narrow_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'fit_loosefit_stright_front':
			$name = $result_image[0]['fit_loosefit_stright_front'];
			$field_name = 'fit_loosefit_stright_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'fit_loosefit_bellbottom_front':
			$name = $result_image[0]['fit_loosefit_bellbottom_front'];
			$field_name = 'fit_loosefit_bellbottom_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
...
//	---------------------------------------------------------------///
		...
		case 'fit_loosefit_narrow_back':
			$name = $result_image[0]['fit_loosefit_narrow_back'];
			$field_name = 'fit_loosefit_narrow_back';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'fit_loosefit_stright_back':
			$name = $result_image[0]['fit_loosefit_stright_back'];
			$field_name = 'fit_loosefit_stright_back';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'fit_loosefit_bellbottom_back':
			$name = $result_image[0]['fit_loosefit_bellbottom_back'];
			$field_name = 'fit_loosefit_bellbottom_back';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
...
//	---------------------------------------------------------------///
		...
		case 'waist_high_cross_pocket_front':
			$name = $result_image[0]['waist_high_cross_pocket_front'];
			$field_name = 'waist_high_cross_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_high_stright_pocket_front':
			$name = $result_image[0]['waist_high_stright_pocket_front'];
			$field_name = 'waist_high_stright_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_high_round_pocket_front':
			$name = $result_image[0]['waist_high_round_pocket_front'];
			$field_name = 'waist_high_round_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_high_lshape_pocket_front':
			$name = $result_image[0]['waist_high_lshape_pocket_front'];
			$field_name = 'waist_high_lshape_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_high_no_pocket_front':
			$name = $result_image[0]['waist_high_no_pocket_front'];
			$field_name = 'waist_high_no_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
...
//	---------------------------------------------------------------///
		...
		case 'waist_medium_cross_pocket_front':
			$name = $result_image[0]['waist_medium_cross_pocket_front'];
			$field_name = 'waist_medium_cross_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_medium_stright_pocket_front':
			$name = $result_image[0]['waist_medium_stright_pocket_front'];
			$field_name = 'waist_medium_stright_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_medium_round_pocket_front':
			$name = $result_image[0]['waist_medium_round_pocket_front'];
			$field_name = 'waist_medium_round_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_medium_lshape_pocket_front':
			$name = $result_image[0]['waist_medium_lshape_pocket_front'];
			$field_name = 'waist_medium_lshape_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_medium_no_pocket_pocket_front':
			$name = $result_image[0]['waist_medium_no_pocket_pocket_front'];
			$field_name = 'waist_medium_no_pocket_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
...
//	---------------------------------------------------------------///
		...
		case 'waist_low_cross_pocket_front':
			$name = $result_image[0]['waist_low_cross_pocket_front'];
			$field_name = 'waist_low_cross_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_low_stright_pocket_front':
			$name = $result_image[0]['waist_low_stright_pocket_front'];
			$field_name = 'waist_low_stright_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_low_round_pocket_front':
			$name = $result_image[0]['waist_low_round_pocket_front'];
			$field_name = 'waist_low_round_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_low_lshape_pocket_front':
			$name = $result_image[0]['waist_low_lshape_pocket_front'];
			$field_name = 'waist_low_lshape_pocket_front';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
...
//	--------------------------------------------------------------------------------------------------------------------------------///
		...
		case 'waist_low_back_pocket_left_singlewelthook':
			$name = $result_image[0]['waist_low_back_pocket_left_singlewelthook'];
			$field_name = 'waist_low_back_pocket_left_singlewelthook';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_low_back_pocket_left_doublewelthook':
			$name = $result_image[0]['waist_low_back_pocket_left_doublewelthook'];
			$field_name = 'waist_low_back_pocket_left_doublewelthook';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_low_back_pocket_left_singleweltbutton':
			$name = $result_image[0]['waist_low_back_pocket_left_singleweltbutton'];
			$field_name = 'waist_low_back_pocket_left_singleweltbutton';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_low_back_pocket_left_doubleweltbutton':
			$name = $result_image[0]['waist_low_back_pocket_left_doubleweltbutton'];
			$field_name = 'waist_low_back_pocket_left_doubleweltbutton';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
...
//	--------------------------------------------------------------------------------------------------------------------------------///
		...
		case 'waist_low_back_pocket_right_singlewelthook':
			$name = $result_image[0]['waist_low_back_pocket_right_singlewelthook'];
			$field_name = 'waist_low_back_pocket_right_singlewelthook';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_low_back_pocket_right_doublewelthook':
			$name = $result_image[0]['waist_low_back_pocket_right_doublewelthook'];
			$field_name = 'waist_low_back_pocket_right_doublewelthook';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_low_back_pocket_right_singleweltbutton':
			$name = $result_image[0]['waist_low_back_pocket_right_singleweltbutton'];
			$field_name = 'waist_low_back_pocket_right_singleweltbutton';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_low_back_pocket_right_doubleweltbutton':
			$name = $result_image[0]['waist_low_back_pocket_right_doubleweltbutton'];
			$field_name = 'waist_low_back_pocket_right_doubleweltbutton';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
...
//	--------------------------------------------------------------------------------------------------------------------------------///
		...
		case 'waist_low_back_pocket_both_singlewelthook':
			$name = $result_image[0]['waist_low_back_pocket_both_singlewelthook'];
			$field_name = 'waist_low_back_pocket_both_singlewelthook';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_low_back_pocket_both_doublewelthook':
			$name = $result_image[0]['waist_low_back_pocket_both_doublewelthook'];
			$field_name = 'waist_low_back_pocket_both_doublewelthook';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_low_back_pocket_both_singleweltbutton':
			$name = $result_image[0]['waist_low_back_pocket_both_singleweltbutton'];
			$field_name = 'waist_low_back_pocket_both_singleweltbutton';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
		case 'waist_low_back_pocket_both_doubleweltbutton':
			$name = $result_image[0]['waist_low_back_pocket_both_doubleweltbutton'];
			$field_name = 'waist_low_back_pocket_both_doubleweltbutton';
			//Deleting main image
			$newname = "upload/Pant/".$productname."/". $name;
            unlink($newname);
			break;
...
//	---------------------------------------------------------------------------------------------------------------------------------------///
	...
	$updatesql = "UPDATE `pantcustomization` SET `".$field_name."`='' WHERE `pantcustomizationid`='".$_REQUEST['del']."'"; //die();
...
//	---------------------------------------------------------------///
    ...
    $extension = getExtension($_FILES['fit_slimfit_narrow_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
	if ($_FILES['fit_slimfit_narrow_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			...
			//$target_path = "upload/Pant/" .$productname."/".basename($name);
   				if(move_uploaded_file($_FILES['fit_slimfit_narrow_front']['tmp_name'], $target_path)) { 
	                $newname = "upload/Pant/".$productname."/". $name;
            } else {
	...
	$fit_slimfit_narrow_front_cond = "`fit_slimfit_narrow_front`='$name',";
	$fit_slimfit_narrow_front_inst_cond = "`fit_slimfit_narrow_front`,";
	$fit_slimfit_narrow_front_inst_cond2 = "'$name',";
	}
	
   
    $extension = getExtension($_FILES['fit_slimfit_stright_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_slimfit_stright_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_slimfit_stright_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_slimfit_stright_front_cond = "`fit_slimfit_stright_front`='$name',";
		$fit_slimfit_stright_front_inst_cond = "`fit_slimfit_stright_front`,";
		$fit_slimfit_stright_front_inst_cond2 = "'$name',";
    }
	
	
	$extension = getExtension($_FILES['fit_slimfit_bellbottom_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_slimfit_bellbottom_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_slimfit_bellbottom_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_slimfit_bellbottom_front_cond = "`fit_slimfit_bellbottom_front`='$name',";
		$fit_slimfit_bellbottom_front_inst_cond = "`fit_slimfit_bellbottom_front`,";
		$fit_slimfit_bellbottom_front_inst_cond2 = "'$name',";
    }
	
//	---------------------------------------------------------------///
	$extension = getExtension($_FILES['fit_slimfit_narrow_back']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_slimfit_narrow_back']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_slimfit_narrow_back']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_slimfit_narrow_back_cond = "`fit_slimfit_narrow_back`='$name',";
		$fit_slimfit_narrow_back_inst_cond = "`fit_slimfit_narrow_back`,";
		$fit_slimfit_narrow_back_inst_cond2 = "'$name',";
    }
	
	
	$extension = getExtension($_FILES['fit_slimfit_stright_back']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_slimfit_stright_back']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_slimfit_stright_back']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_slimfit_stright_back_cond = "`fit_slimfit_stright_back`='$name',";
		$fit_slimfit_stright_back_inst_cond = "`fit_slimfit_stright_back`,";
		$fit_slimfit_stright_back_inst_cond2 = "'$name',";
    }
	
	
	$extension = getExtension($_FILES['fit_slimfit_bellbottom_back']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_slimfit_bellbottom_back']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_slimfit_bellbottom_back']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_slimfit_bellbottom_back_cond = "`fit_slimfit_bellbottom_back`='$name',";
		$fit_slimfit_bellbottom_back_inst_cond = "`fit_slimfit_bellbottom_back`,";
		$fit_slimfit_bellbottom_back_inst_cond2 = "'$name',";
    }
	
	
//	---------------------------------------------------------------///	
	
	$extension = getExtension($_FILES['fit_normalfit_narrow_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_normalfit_narrow_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            ...
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_normalfit_narrow_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_normalfit_narrow_front_cond = "`fit_normalfit_narrow_front`='$name',";
		$fit_normalfit_narrow_front_inst_cond = "`fit_normalfit_narrow_front`,";
		$fit_normalfit_narrow_front_inst_cond2 = "'$name',";
    }
	

	
	$extension = getExtension($_FILES['fit_normalfit_stright_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_normalfit_stright_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_normalfit_stright_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_normalfit_stright_front_cond = "`fit_normalfit_stright_front`='$name',";
		$fit_normalfit_stright_front_inst_cond = "`fit_normalfit_stright_front`,";
		$fit_normalfit_stright_front_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['fit_normalfit_bellbottom_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_normalfit_bellbottom_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_normalfit_bellbottom_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_normalfit_bellbottom_front_cond = "`fit_normalfit_bellbottom_front`='$name',";
		$fit_normalfit_bellbottom_front_inst_cond = "`fit_normalfit_bellbottom_front`,";
		$fit_normalfit_bellbottom_front_inst_cond2 = "'$name',";


    }
	
//	-------------------------------------------------------------------------------------------------------------------------///
	$extension = getExtension($_FILES['fit_normalfit_narrow_back']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_normalfit_narrow_back']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_normalfit_narrow_back']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_normalfit_narrow_back_cond = "`fit_normalfit_narrow_back`='$name',";
		$fit_normalfit_narrow_back_inst_cond = "`fit_normalfit_narrow_back`,";
		$fit_normalfit_narrow_back_inst_cond2 = "'$name',";
    }
	

	
	$extension = getExtension($_FILES['fit_normalfit_stright_back']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_normalfit_stright_back']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_normalfit_stright_back']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_normalfit_stright_back_cond = "`fit_normalfit_stright_back`='$name',";
		$fit_normalfit_stright_back_inst_cond = "`fit_normalfit_stright_back`,";
		$fit_normalfit_stright_back_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['fit_normalfit_bellbottom_back']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_normalfit_bellbottom_back']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_normalfit_bellbottom_back']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_normalfit_bellbottom_back_cond = "`fit_normalfit_bellbottom_back`='$name',";
		$fit_normalfit_bellbottom_back_inst_cond = "`fit_normalfit_bellbottom_back`,";
		$fit_normalfit_bellbottom_back_inst_cond2 = "'$name',";
    }
	
//	---------------------------------------------------------------///

	
	$extension = getExtension($_FILES['fit_loosefit_narrow_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_loosefit_narrow_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_loosefit_narrow_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_loosefit_narrow_front_cond = "`fit_loosefit_narrow_front`='$name',";
		$fit_loosefit_narrow_front_inst_cond = "`fit_loosefit_narrow_front`,";
		$fit_loosefit_narrow_front_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['fit_loosefit_stright_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_loosefit_stright_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_loosefit_stright_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_loosefit_stright_front_cond = "`fit_loosefit_stright_front`='$name',";
		$fit_loosefit_stright_front_inst_cond = "`fit_loosefit_stright_front`,";
		$fit_loosefit_stright_front_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['fit_loosefit_bellbottom_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_loosefit_bellbottom_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_loosefit_bellbottom_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_loosefit_bellbottom_front_cond = "`fit_loosefit_bellbottom_front`='$name',";
		$fit_loosefit_bellbottom_front_inst_cond = "`fit_loosefit_bellbottom_front`,";
		$fit_loosefit_bellbottom_front_inst_cond2 = "'$name',";
    }
	
//	---------------------------------------------------------------///

	$extension = getExtension($_FILES['fit_loosefit_narrow_back']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_loosefit_narrow_back']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_loosefit_narrow_back']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_loosefit_narrow_back_cond = "`fit_loosefit_narrow_back`='$name',";
		$fit_loosefit_narrow_back_inst_cond = "`fit_loosefit_narrow_back`,";
		$fit_loosefit_narrow_back_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['fit_loosefit_stright_back']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_loosefit_stright_back']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_loosefit_stright_back']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_loosefit_stright_back_cond = "`fit_loosefit_stright_back`='$name',";
		$fit_loosefit_stright_back_inst_cond = "`fit_loosefit_stright_back`,";
		$fit_loosefit_stright_back_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['fit_loosefit_bellbottom_back']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['fit_loosefit_bellbottom_back']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['fit_loosefit_bellbottom_back']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$fit_loosefit_bellbottom_back_cond = "`fit_loosefit_bellbottom_back`='$name',";
		$fit_loosefit_bellbottom_back_inst_cond = "`fit_loosefit_bellbottom_back`,";
		$fit_loosefit_bellbottom_back_inst_cond2 = "'$name',";
    }

//-------------------------------------------------------------------------------------------------------------------------------------//	

	$extension = getExtension($_FILES['waist_high_cross_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_high_cross_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_high_cross_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_high_cross_pocket_front_cond = "`waist_high_cross_pocket_front`='$name',";
		$waist_high_cross_pocket_front_inst_cond = "`waist_high_cross_pocket_front`,";
		$waist_high_cross_pocket_front_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_high_stright_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_high_stright_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_high_stright_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_high_stright_pocket_front_cond = "`waist_high_stright_pocket_front`='$name',";
		$waist_high_stright_pocket_front_inst_cond = "`waist_high_stright_pocket_front`,";
		$waist_high_stright_pocket_front_inst_cond2 = "'$name',";
    }
	

	$extension = getExtension($_FILES['waist_high_round_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_high_round_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_high_round_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_high_round_pocket_front_cond = "`waist_high_round_pocket_front`='$name',";
		$waist_high_round_pocket_front_inst_cond = "`waist_high_round_pocket_front`,";
		$waist_high_round_pocket_front_inst_cond2 = "'$name',";
    }

	
	$extension = getExtension($_FILES['waist_high_lshape_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_high_lshape_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_high_lshape_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_high_lshape_pocket_front_cond = "`waist_high_lshape_pocket_front`='$name',";
		$waist_high_lshape_pocket_front_inst_cond = "`waist_high_lshape_pocket_front`,";
		$waist_high_lshape_pocket_front_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_high_no_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_high_no_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_high_no_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_high_no_pocket_front_cond = "`waist_high_no_pocket_front`='$name',";
		$waist_high_no_pocket_front_inst_cond = "`waist_high_no_pocket_front`,";
		$waist_high_no_pocket_front_inst_cond2 = "'$name',";
    }
...
//-------------------------------------------------------------------------------------------------------------------------------------//	
	...
	$extension = getExtension($_FILES['waist_medium_cross_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_medium_cross_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_medium_cross_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_medium_cross_pocket_front_cond = "`waist_medium_cross_pocket_front`='$name',";
		$waist_medium_cross_pocket_front_inst_cond = "`waist_medium_cross_pocket_front`,";
		$waist_medium_cross_pocket_front_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_medium_stright_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_medium_stright_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_medium_stright_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_medium_stright_pocket_front_cond = "`waist_medium_stright_pocket_front`='$name',";
		$waist_medium_stright_pocket_front_inst_cond = "`waist_medium_stright_pocket_front`,";
		$waist_medium_stright_pocket_front_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_medium_round_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_medium_round_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_medium_round_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_medium_round_pocket_front_cond = "`waist_medium_round_pocket_front`='$name',";
		$waist_medium_round_pocket_front_inst_cond = "`waist_medium_round_pocket_front`,";
		$waist_medium_round_pocket_front_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_medium_lshape_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_medium_lshape_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_medium_lshape_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_medium_lshape_pocket_front_cond = "`waist_medium_lshape_pocket_front`='$name',";
		$waist_medium_lshape_pocket_front_inst_cond = "`waist_medium_lshape_pocket_front`,";
		$waist_medium_lshape_pocket_front_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_medium_no_pocket_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_medium_no_pocket_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_medium_no_pocket_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_medium_no_pocket_pocket_front_cond = "`waist_medium_no_pocket_pocket_front`='$name',";
		$waist_medium_no_pocket_pocket_front_inst_cond = "`waist_medium_no_pocket_pocket_front`,";
		$waist_medium_no_pocket_pocket_front_inst_cond2 = "'$name',";
    }
...
//-------------------------------------------------------------------------------------------------------------------------------------//	
	...
	$extension = getExtension($_FILES['waist_low_cross_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_cross_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_cross_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_cross_pocket_front_cond = "`waist_low_cross_pocket_front`='$name',";
		$waist_low_cross_pocket_front_inst_cond = "`waist_low_cross_pocket_front`,";
		$waist_low_cross_pocket_front_inst_cond2 = "'$name',";
    }

	$extension = getExtension($_FILES['waist_low_stright_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_stright_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_stright_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_stright_pocket_front_cond = "`waist_low_stright_pocket_front`='$name',";
		$waist_low_stright_pocket_front_inst_cond = "`waist_low_stright_pocket_front`,";
		$waist_low_stright_pocket_front_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_low_round_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_round_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_round_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_round_pocket_front_cond = "`waist_low_round_pocket_front`='$name',";
		$waist_low_round_pocket_front_inst_cond = "`waist_low_round_pocket_front`,";
		$waist_low_round_pocket_front_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_low_lshape_pocket_front']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_lshape_pocket_front']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_lshape_pocket_front']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_lshape_pocket_front_cond = "`waist_low_lshape_pocket_front`='$name',";
		$waist_low_lshape_pocket_front_inst_cond = "`waist_low_lshape_pocket_front`,";
		$waist_low_lshape_pocket_front_inst_cond2 = "'$name',";
    }
...
//	--------------------------------------------------------------------------------------------------------------------------------///
	...
	$extension = getExtension($_FILES['waist_low_back_pocket_left_singlewelthook']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_back_pocket_left_singlewelthook']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_back_pocket_left_singlewelthook']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_back_pocket_left_singlewelthook_cond = "`waist_low_back_pocket_left_singlewelthook`='$name',";
		$waist_low_back_pocket_left_singlewelthook_inst_cond = "`waist_low_back_pocket_left_singlewelthook`,";
		$waist_low_back_pocket_left_singlewelthook_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_low_back_pocket_left_doublewelthook']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_back_pocket_left_doublewelthook']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_back_pocket_left_doublewelthook']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_back_pocket_left_doublewelthook_cond = "`waist_low_back_pocket_left_doublewelthook`='$name',";
		$waist_low_back_pocket_left_doublewelthook_inst_cond = "`waist_low_back_pocket_left_doublewelthook`,";
		$waist_low_back_pocket_left_doublewelthook_inst_cond2 = "'$name',";
    }


	$extension = getExtension($_FILES['waist_low_back_pocket_left_singleweltbutton']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_back_pocket_left_singleweltbutton']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_back_pocket_left_singleweltbutton']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_back_pocket_left_singleweltbutton_cond = "`waist_low_back_pocket_left_singleweltbutton`='$name',";
		$waist_low_back_pocket_left_singleweltbutton_inst_cond = "`waist_low_back_pocket_left_singleweltbutton`,";
		$waist_low_back_pocket_left_singleweltbutton_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_low_back_pocket_left_doubleweltbutton']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_back_pocket_left_doubleweltbutton']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_back_pocket_left_doubleweltbutton']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_back_pocket_left_doubleweltbutton_cond = "`waist_low_back_pocket_left_doubleweltbutton`='$name',";
		$waist_low_back_pocket_left_doubleweltbutton_inst_cond = "`waist_low_back_pocket_left_doubleweltbutton`,";
		$waist_low_back_pocket_left_doubleweltbutton_inst_cond2 = "'$name',";
    }
	
//	--------------------------------------------------------------------------------------------------------------------------------///


	$extension = getExtension($_FILES['waist_low_back_pocket_right_singlewelthook']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_back_pocket_right_singlewelthook']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_back_pocket_right_singlewelthook']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_back_pocket_right_singlewelthook_cond = "`waist_low_back_pocket_right_singlewelthook`='$name',";
		$waist_low_back_pocket_right_singlewelthook_inst_cond = "`waist_low_back_pocket_right_singlewelthook`,";
		$waist_low_back_pocket_right_singlewelthook_inst_cond2 = "'$name',";
    }

	
	$extension = getExtension($_FILES['waist_low_back_pocket_right_doublewelthook']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_back_pocket_right_doublewelthook']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_back_pocket_right_doublewelthook']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_back_pocket_right_doublewelthook_cond = "`waist_low_back_pocket_right_doublewelthook`='$name',";
		$waist_low_back_pocket_right_doublewelthook_inst_cond = "`waist_low_back_pocket_right_doublewelthook`,";
		$waist_low_back_pocket_right_doublewelthook_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_low_back_pocket_right_singleweltbutton']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_back_pocket_right_singleweltbutton']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_back_pocket_right_singleweltbutton']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_back_pocket_right_singleweltbutton_cond = "`waist_low_back_pocket_right_singleweltbutton`='$name',";
		$waist_low_back_pocket_right_singleweltbutton_inst_cond = "`waist_low_back_pocket_right_singleweltbutton`,";
		$waist_low_back_pocket_right_singleweltbutton_inst_cond2 = "'$name',";
    }

	
	$extension = getExtension($_FILES['waist_low_back_pocket_right_doubleweltbutton']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_back_pocket_right_doubleweltbutton']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_back_pocket_right_doubleweltbutton']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_back_pocket_right_doubleweltbutton_cond = "`waist_low_back_pocket_right_doubleweltbutton`='$name',";
		$waist_low_back_pocket_right_doubleweltbutton_inst_cond = "`waist_low_back_pocket_right_doubleweltbutton`,";
		$waist_low_back_pocket_right_doubleweltbutton_inst_cond2 = "'$name',";
    }
	
//-------------------------------------------------------------------------------------------------------------------------------------//	

	
	$extension = getExtension($_FILES['waist_low_back_pocket_both_singlewelthook']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_back_pocket_both_singlewelthook']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_back_pocket_both_singlewelthook']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_back_pocket_both_singlewelthook_cond = "`waist_low_back_pocket_both_singlewelthook`='$name',";
		$waist_low_back_pocket_both_singlewelthook_inst_cond = "`waist_low_back_pocket_both_singlewelthook`,";
		$waist_low_back_pocket_both_singlewelthook_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_low_back_pocket_both_doublewelthook']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_back_pocket_both_doublewelthook']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_back_pocket_both_doublewelthook']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_back_pocket_both_doublewelthook_cond = "`waist_low_back_pocket_both_doublewelthook`='$name',";
		$waist_low_back_pocket_both_doublewelthook_inst_cond = "`waist_low_back_pocket_both_doublewelthook`,";
		$waist_low_back_pocket_both_doublewelthook_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_low_back_pocket_both_singleweltbutton']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_back_pocket_both_singleweltbutton']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_back_pocket_both_singleweltbutton']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_back_pocket_both_singleweltbutton_cond = "`waist_low_back_pocket_both_singleweltbutton`='$name',";
		$waist_low_back_pocket_both_singleweltbutton_inst_cond = "`waist_low_back_pocket_both_singleweltbutton`,";

		$waist_low_back_pocket_both_singleweltbutton_inst_cond2 = "'$name',";
    }
	
	$extension = getExtension($_FILES['waist_low_back_pocket_both_doubleweltbutton']['name']);
    $extension = strtolower($extension);
    $uni = uniqid();
    if ($_FILES['waist_low_back_pocket_both_doubleweltbutton']['name'] != '') {
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif' || $extension == 'png')
		{
			$folder = mkdir("upload/Pant/".$productname, 0777);
            $name = $productname.$uni . '.' . $extension;
            $target_path = "upload/Pant/".$productname."/";
            $target_path = $target_path . basename($name);
            if (move_uploaded_file($_FILES['waist_low_back_pocket_both_doubleweltbutton']['tmp_name'], $target_path)) {
                //Find old pic
                $newname = "upload/Pant/".$productname."/". $name;
            } else {
                header("location:pantcustomization.php?productid=".$_REQUEST['productid']."&msg=2");
		...
		$waist_low_back_pocket_both_doubleweltbutton_cond = "`waist_low_back_pocket_both_doubleweltbutton`='$name',";
		$waist_low_back_pocket_both_doubleweltbutton_inst_cond = "`waist_low_back_pocket_both_doubleweltbutton`,";
		$waist_low_back_pocket_both_doubleweltbutton_inst_cond2 = "'$name',";
    }
...
//-------------------------------------------------------------------------------------------------------------------------------------//	
	...
	$result_image = $obj_db->select($sql);
	 ...
	 if(($result_image))
	 {
		 $update_string = $fit_slimfit_narrow_front_cond."".$fit_slimfit_stright_front_cond."".$fit_slimfit_bellbottom_front_cond."".$fit_slimfit_narrow_back_cond."".$fit_slimfit_stright_back_cond."".$fit_slimfit_bellbottom_back_cond."".$fit_normalfit_narrow_front_cond."".$fit_normalfit_stright_front_cond."".$fit_normalfit_bellbottom_front_cond."".$fit_normalfit_narrow_back_cond."".$fit_normalfit_stright_back_cond."".$fit_normalfit_bellbottom_back_cond."".$fit_loosefit_narrow_front_cond."".$fit_loosefit_stright_front_cond."".$fit_loosefit_bellbottom_front_cond."".$fit_loosefit_narrow_back_cond."".$fit_loosefit_stright_back_cond."".$fit_loosefit_bellbottom_back_cond."".$waist_high_cross_pocket_front_cond."".$waist_high_stright_pocket_front_cond."".$waist_high_round_pocket_front_cond."".$waist_high_lshape_pocket_front_cond."".$waist_high_no_pocket_front_cond."".$waist_medium_cross_pocket_front_cond."".$waist_medium_stright_pocket_front_cond."".$waist_medium_round_pocket_front_cond."".$waist_medium_lshape_pocket_front_cond."".$waist_medium_no_pocket_pocket_front_cond."".$waist_low_cross_pocket_front_cond."".$waist_low_stright_pocket_front_cond."".$waist_low_round_pocket_front_cond."".$waist_low_lshape_pocket_front_cond."".$waist_low_no_pocket_pocket_front_cond."".$pleats_single_cond."".$pleats_double_cond."".$pleats_single_reserved_cond."".$pleats_double_reserved_cond."".$pleats_box_cond."".$pleats_without_box_cond."".$waist_high_belt_cut_buttoned_front_cond."".$waist_high_belt_cut_hock_front_cond."".$waist_high_belt_long_buttoned_front_cond."".$waist_high_belt_long_hook_front_cond."".$waist_high_belt_long_hook_buttoned_front_cond."".$waist_medium_belt_cut_buttoned_front_cond."".$waist_medium_belt_cut_hock_front_cond."".$waist_medium_belt_long_buttoned_front_cond."".$waist_medium_belt_long_hook_front_cond."".$waist_medium_belt_long_hook_buttoned_front_cond."".$waist_low_belt_cut_buttoned_front_cond."".$waist_low_belt_cut_hock_front_cond."".$waist_low_belt_long_buttoned_front_cond."".$waist_low_belt_long_hook_front_cond."".$waist_low_belt_long_hook_buttoned_front_cond."".$fly_buttoned_cond."".$fly_zipper_cond."".$waist_high_back_pocket_left_singlewelthook_cond."".$waist_high_back_pocket_left_doublewelthook_cond."".$waist_high_back_pocket_left_singleweltbutton_cond."".$waist_high_back_pocket_left_doubleweltbutton_cond."".$waist_high_back_pocket_right_singlewelthook_cond."".$waist_high_back_pocket_right_doublewelthook_cond."".$waist_high_back_pocket_right_singleweltbutton_cond."".$waist_high_back_pocket_right_doubleweltbutton_cond."".$waist_high_back_pocket_both_singlewelthook_cond."".$waist_high_back_pocket_both_doublewelthook_cond."".$waist_high_back_pocket_both_singleweltbutton_cond."".$waist_high_back_pocket_both_doubleweltbutton_cond."".$waist_medium_back_pocket_left_singlewelthook_cond."".$waist_medium_back_pocket_left_doublewelthook_cond."".$waist_medium_back_pocket_left_singleweltbutton_cond."".$waist_medium_back_pocket_left_doubleweltbutton_cond."".$waist_medium_back_pocket_right_singlewelthook_cond."".$waist_medium_back_pocket_right_doublewelthook_cond."".$waist_medium_back_pocket_right_singleweltbutton_cond."".$waist_medium_back_pocket_right_doubleweltbutton_cond."".$waist_medium_back_pocket_both_singlewelthook_cond."".$waist_medium_back_pocket_both_doublewelthook_cond."".$waist_medium_back_pocket_both_singleweltbutton_cond."".$waist_medium_back_pocket_both_doubleweltbutton_cond."".$waist_low_back_pocket_left_singlewelthook_cond."".$waist_low_back_pocket_left_doublewelthook_cond."".$waist_low_back_pocket_left_singleweltbutton_cond."".$waist_low_back_pocket_left_doubleweltbutton_cond."".$waist_low_back_pocket_right_singlewelthook_cond."".$waist_low_back_pocket_right_doublewelthook_cond."".$waist_low_back_pocket_right_singleweltbutton_cond."".$waist_low_back_pocket_right_doubleweltbutton_cond."".$waist_low_back_pocket_both_singlewelthook_cond."".$waist_low_back_pocket_both_doublewelthook_cond."".$waist_low_back_pocket_both_singleweltbutton_cond."".$waist_low_back_pocket_both_doubleweltbutton_cond."".$waist_high_belt_back_cond."".$waist_medium_belt_back_cond."".$waist_low_belt_back_cond;
   ...
   die();
	  ...
	  {
       $sql="INSERT INTO pantcustomization (`productid`,".$fit_slimfit_narrow_front_inst_cond."  ".$fit_slimfit_stright_front_inst_cond."  ".$fit_slimfit_bellbottom_front_inst_cond."  ".$fit_slimfit_narrow_back_inst_cond."  ".$fit_slimfit_stright_back_inst_cond."  ".$fit_slimfit_bellbottom_back_inst_cond."  ".$fit_normalfit_narrow_front_inst_cond."  ".$fit_normalfit_stright_front_inst_cond."  ".$fit_normalfit_bellbottom_front_inst_cond."  ".$fit_normalfit_narrow_back_inst_cond."  ".$fit_normalfit_stright_back_inst_cond."  ".$fit_normalfit_bellbottom_back_inst_cond."  ".$fit_loosefit_narrow_front_inst_cond."  ".$fit_loosefit_stright_front_inst_cond."  ".$fit_loosefit_bellbottom_front_inst_cond." ".$fit_loosefit_narrow_back_inst_cond." ".$fit_loosefit_stright_back_inst_cond."  ".$fit_loosefit_bellbottom_back_inst_cond."  ".$waist_high_cross_pocket_front_inst_cond."  ".$waist_high_stright_pocket_front_inst_cond."  ".$waist_high_round_pocket_front_inst_cond."  ".$waist_high_lshape_pocket_front_inst_cond." ".$waist_high_no_pocket_front_inst_cond." ".$waist_medium_cross_pocket_front_inst_cond."  ".$waist_medium_stright_pocket_front_inst_cond."  ".$waist_medium_round_pocket_front_inst_cond."  ".$waist_medium_lshape_pocket_front_inst_cond."  ".$waist_medium_no_pocket_pocket_front_inst_cond."  ".$waist_low_cross_pocket_front_inst_cond."  ".$waist_low_stright_pocket_front_inst_cond."  ".$waist_low_round_pocket_front_inst_cond."  ".$waist_low_lshape_pocket_front_inst_cond." ".$waist_low_no_pocket_pocket_front_inst_cond."  ".$pleats_single_inst_cond."  ".$pleats_double_inst_cond."  ".$pleats_single_reserved_inst_cond."  ".$pleats_double_reserved_inst_cond."  ".$pleats_box_inst_cond."  ".$pleats_without_box_inst_cond."  ".$waist_high_belt_cut_buttoned_front_inst_cond."  ".$waist_high_belt_cut_hock_front_inst_cond."  ".$waist_high_belt_long_buttoned_front_inst_cond."  ".$waist_high_belt_long_hook_front_inst_cond."  ".$waist_high_belt_long_hook_buttoned_front_inst_cond."  ".$waist_medium_belt_cut_buttoned_front_inst_cond."  ".$waist_medium_belt_cut_hock_front_inst_cond."  ".$waist_medium_belt_long_buttoned_front_inst_cond." ".$waist_medium_belt_long_hook_front_inst_cond." ".$waist_medium_belt_long_hook_buttoned_front_inst_cond."  ".$waist_low_belt_cut_buttoned_front_inst_cond."  ".$waist_low_belt_cut_hock_front_inst_cond."  ".$waist_low_belt_long_buttoned_front_inst_cond."  ".$waist_low_belt_long_hook_front_inst_cond."  ".$waist_low_belt_long_hook_buttoned_front_inst_cond." ".$fly_buttoned_inst_cond." ".$fly_zipper_inst_cond."  ".$waist_high_back_pocket_left_singlewelthook_inst_cond."  ".$waist_high_back_pocket_left_doublewelthook_inst_cond."  ".$waist_high_back_pocket_left_singleweltbutton_inst_cond."  ".$waist_high_back_pocket_left_doubleweltbutton_inst_cond."  ".$waist_high_back_pocket_right_singlewelthook_inst_cond."  ".$waist_high_back_pocket_right_doublewelthook_inst_cond."  ".$waist_high_back_pocket_right_singleweltbutton_inst_cond."  ".$waist_high_back_pocket_right_doubleweltbutton_inst_cond."  ".$waist_high_back_pocket_both_singlewelthook_inst_cond."  ".$waist_high_back_pocket_both_doublewelthook_inst_cond."  ".$waist_high_back_pocket_both_singleweltbutton_inst_cond."  ".$waist_high_back_pocket_both_doubleweltbutton_inst_cond."  ".$waist_medium_back_pocket_left_singlewelthook_inst_cond."  ".$waist_medium_back_pocket_left_doublewelthook_inst_cond."  ".$waist_medium_back_pocket_left_singleweltbutton_inst_cond."  ".$waist_medium_back_pocket_left_doubleweltbutton_inst_cond."  ".$waist_medium_back_pocket_right_singlewelthook_inst_cond."  ".$waist_medium_back_pocket_right_doublewelthook_inst_cond."  ".$waist_medium_back_pocket_right_singleweltbutton_inst_cond."  ".$waist_medium_back_pocket_right_doubleweltbutton_inst_cond."  ".$waist_medium_back_pocket_both_singlewelthook_inst_cond."  ".$waist_medium_back_pocket_both_doublewelthook_inst_cond."  ".$waist_medium_back_pocket_both_singleweltbutton_inst_cond." ".$waist_medium_back_pocket_both_doubleweltbutton_inst_cond." ".$waist_low_back_pocket_left_singlewelthook_inst_cond."  ".$waist_low_back_pocket_left_doublewelthook_inst_cond."  ".$waist_low_back_pocket_left_singleweltbutton_inst_cond."  ".$waist_low_back_pocket_left_doubleweltbutton_inst_cond."  ".$waist_low_back_pocket_right_singlewelthook_inst_cond."  ".$waist_low_back_pocket_right_doublewelthook_inst_cond." ".$waist_low_back_pocket_right_singleweltbutton_inst_cond." ".$waist_low_back_pocket_right_doubleweltbutton_inst_cond."  ".$waist_low_back_pocket_both_singlewelthook_inst_cond."  ".$waist_low_back_pocket_both_doublewelthook_inst_cond."  ".$waist_low_back_pocket_both_singleweltbutton_inst_cond."  ".$waist_low_back_pocket_both_doubleweltbutton_inst_cond."  ".$waist_high_belt_back_inst_cond."  ".$waist_medium_belt_back_inst_cond."  ".$waist_low_belt_back_inst_cond."  `adate`) 
		VALUES ('$productid',".$fit_slimfit_narrow_front_inst_cond2."   ".$fit_slimfit_stright_front_inst_cond2."  ".$fit_slimfit_bellbottom_front_inst_cond2."   ".$fit_slimfit_narrow_back_inst_cond2."  ".$fit_slimfit_stright_back_inst_cond2."  ".$fit_slimfit_bellbottom_back_inst_cond2."  ".$fit_normalfit_narrow_front_inst_cond2."  ".$fit_normalfit_stright_front_inst_cond2."  ".$fit_normalfit_bellbottom_front_inst_cond2."  ".$fit_normalfit_narrow_back_inst_cond2."  ".$fit_normalfit_stright_back_inst_cond2."  ".$fit_normalfit_bellbottom_back_inst_cond2."  ".$fit_loosefit_narrow_front_inst_cond2."  ".$fit_loosefit_stright_front_inst_cond2." ".$fit_loosefit_bellbottom_front_inst_cond2." ".$fit_loosefit_narrow_back_inst_cond2." ".$fit_loosefit_stright_back_inst_cond2." ".$fit_loosefit_bellbottom_back_inst_cond2."  ".$waist_high_cross_pocket_front_inst_cond2."  ".$waist_high_stright_pocket_front_inst_cond2."  ".$waist_high_round_pocket_front_inst_cond2."  ".$waist_high_lshape_pocket_front_inst_cond2." ".$waist_high_no_pocket_front_inst_cond2." ".$waist_medium_cross_pocket_front_inst_cond2."  ".$waist_medium_stright_pocket_front_inst_cond2."  ".$waist_medium_round_pocket_front_inst_cond2."  ".$waist_medium_lshape_pocket_front_inst_cond2."  ".$waist_medium_no_pocket_pocket_front_inst_cond2."  ".$waist_low_cross_pocket_front_inst_cond2."  ".$waist_low_stright_pocket_front_inst_cond2."  ".$waist_low_round_pocket_front_inst_cond2."  ".$waist_low_lshape_pocket_front_inst_cond2."".$waist_low_no_pocket_pocket_front_inst_cond2."   ".$pleats_single_inst_cond2."  ".$pleats_double_inst_cond2."   ".$pleats_single_reserved_inst_cond2."  ".$pleats_double_reserved_inst_cond2."  ".$pleats_box_inst_cond2."  ".$pleats_without_box_inst_cond2."  ".$waist_high_belt_cut_buttoned_front_inst_cond2."  ".$waist_high_belt_cut_hock_front_inst_cond2."  ".$waist_high_belt_long_buttoned_front_inst_cond2."  ".$waist_high_belt_long_hook_front_inst_cond2."  ".$waist_high_belt_long_hook_buttoned_front_inst_cond2."  ".$waist_medium_belt_cut_buttoned_front_inst_cond2."  ".$waist_medium_belt_cut_hock_front_inst_cond2." ".$waist_medium_belt_long_buttoned_front_inst_cond2." ".$waist_medium_belt_long_hook_front_inst_cond2." ".$waist_medium_belt_long_hook_buttoned_front_inst_cond2." ".$waist_low_belt_cut_buttoned_front_inst_cond2."  ".$waist_low_belt_cut_hock_front_inst_cond2."  ".$waist_low_belt_long_buttoned_front_inst_cond2."  ".$waist_low_belt_long_hook_front_inst_cond2."  ".$waist_low_belt_long_hook_buttoned_front_inst_cond2." ".$fly_buttoned_inst_cond2." ".$fly_zipper_inst_cond2."  ".$waist_high_back_pocket_left_singlewelthook_inst_cond2."  ".$waist_high_back_pocket_left_doublewelthook_inst_cond2."  ".$waist_high_back_pocket_left_singleweltbutton_inst_cond2."  ".$waist_high_back_pocket_left_doubleweltbutton_inst_cond2."  ".$waist_high_back_pocket_right_singlewelthook_inst_cond2."  ".$waist_high_back_pocket_right_doublewelthook_inst_cond2."  ".$waist_high_back_pocket_right_singleweltbutton_inst_cond2."  ".$waist_high_back_pocket_right_doubleweltbutton_inst_cond2."  ".$waist_high_back_pocket_both_singlewelthook_inst_cond2."   ".$waist_high_back_pocket_both_doublewelthook_inst_cond2."  ".$waist_high_back_pocket_both_singleweltbutton_inst_cond2."   ".$waist_high_back_pocket_both_doubleweltbutton_inst_cond2."  ".$waist_medium_back_pocket_left_singlewelthook_inst_cond2."  ".$waist_medium_back_pocket_left_doublewelthook_inst_cond2."  ".$waist_medium_back_pocket_left_singleweltbutton_inst_cond2."  ".$waist_medium_back_pocket_left_doubleweltbutton_inst_cond2."  ".$waist_medium_back_pocket_right_singlewelthook_inst_cond2."  ".$waist_medium_back_pocket_right_doublewelthook_inst_cond2."  ".$waist_medium_back_pocket_right_singleweltbutton_inst_cond2."  ".$waist_medium_back_pocket_right_doubleweltbutton_inst_cond2."  ".$waist_medium_back_pocket_both_singlewelthook_inst_cond2."  ".$waist_medium_back_pocket_both_doublewelthook_inst_cond2." ".$waist_medium_back_pocket_both_singleweltbutton_inst_cond2." ".$waist_medium_back_pocket_both_doubleweltbutton_inst_cond2." ".$waist_low_back_pocket_left_singlewelthook_inst_cond2." ".$waist_low_back_pocket_left_doublewelthook_inst_cond2."  ".$waist_low_back_pocket_left_singleweltbutton_inst_cond2."  ".$waist_low_back_pocket_left_doubleweltbutton_inst_cond2."  ".$waist_low_back_pocket_right_singlewelthook_inst_cond2."  ".$waist_low_back_pocket_right_doublewelthook_inst_cond2." ".$waist_low_back_pocket_right_singleweltbutton_inst_cond2." ".$waist_low_back_pocket_right_doubleweltbutton_inst_cond2."  ".$waist_low_back_pocket_both_singlewelthook_inst_cond2."  ".$waist_low_back_pocket_both_doublewelthook_inst_cond2."  ".$waist_low_back_pocket_both_singleweltbutton_inst_cond2."  ".$waist_low_back_pocket_both_doubleweltbutton_inst_cond2."  ".$waist_high_belt_back_inst_cond2."  ".$waist_medium_belt_back_inst_cond2."  ".$waist_low_belt_back_inst_cond2."  NOW())";  //die();
