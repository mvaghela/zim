...
<div class="Products-image" id="">
	<?php $sql = "select * from `shirtcustomization` where productid = ".$_GET['id']."";
...
$_SESSION['backtype'] = 'back_sidepleats';
 ...
 ?>
	<div id="fabric_design_details_middle_picture_view1" class=""> 
		...
		<!----------------Blank----------------> 
		<img id="20" src="images/shirts/rounded_files/shirtimage/blank.gif" name="undefined" title="undefined" style="position: absolute; display: block; z-index: 20;"> <img id="19" src="images/shirts/rounded_files/shirtimage/blank.gif" name="undefined" title="undefined" style="position: absolute; display: block; z-index: 19;"> <img id="18" src="images/shirts/rounded_files/shirtimage/blank.gif" name="sewn in" title="sewn in" style="position: absolute; display: block; z-index: 18;"> <img id="4" src="images/shirts/rounded_files/shirtimage/blank.gif" name="noloops" title="noloops" style="position: absolute; display: block; z-index: 4;"> 
		...
		<!----------------collar----------------> 
		<img id="14" src="admin/upload/shirt/<?php echo $_SESSION['product'];?>/<?php echo $_SESSION['collarimage']; ?>" name="classic" title="Peace Maker" style="position: absolute; display: block; z-index: 14;"> </div>
</div>
	...
	<table align="center">
		<tr>
			<td><div> 
					...
					<div class="add-to-bag"><a href="confirmmsg.php?id=<?php echo $_SESSION['product'];?>&acn=usedcustomize" id="confirm" class="btn confirm">3D CUSTOMIZE</a></div>
