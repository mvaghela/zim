...
$sql = "select * from `pantcustomizationnew` where productid = ".$_SESSION['productid']."";
...
<div class="button-div">				
				<div class="add-to-bag"><a href="confirmmsgpant.php?acn=addtobag" id="confirm" class="confirm">ADD TO BAG</a></div>
