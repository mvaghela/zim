...
<div class="top">
	<div class="wrapper">
		<ul>
			...
			<?php } else { ?>
			<li><a href="register.php" id="register_link_h">Hi, <?php echo $_SESSION['firstname']; ?></a></li>
	...
	<div class="header">
		...
		<div class="top-menu">
			...
			<ul>
				...
				<li <?php if($currentpage=='shirt.php' || $currentpage=='customize.php') { ?> class="active" <?php } ?>><a href="shirt.php">SHIRTS</a></li>
