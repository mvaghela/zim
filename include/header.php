...
<?php 
$select_menu="SELECT * FROM `cms_pages`";
$menu_res=$obj_db->select($select_menu);
?>
<div class="wrapper">
	<div class="top">
		<ul>
			...
			<!--<li><a href="my_account.php">Hi, <?//php echo $_SESSION['firstname']; ?></a></li>-->
	...
	<div class="header">
		...
		<div class="top-menu">
			...
			<ul>
				<!--<li ><a href="#">NEW</a></li>
				<li <?php// //if($currentpage=='suit.php' || $currentpage=='suitcustomize.php') { ?> class="active" <?php// } ?>><a href="suit.php">SUITS </a></li>-->
				<li <?php if($currentpage=='shirt.php' || $currentpage=='customize.php' || $currentpage=='contrastcustomize.php' || $currentpage=='monogramshirt.php' ) { ?> class="active" <?php } ?>><a href="shirt.php">SHIRTS</a></li>
				<li <?php if($currentpage=='pants.php' || $currentpage=='pantscustomize.php') { ?> class="active" <?php } ?>><a href="pants.php">PANTS</a></li>
				<li <?php if($currentpage=='fabric.php' || $currentpage=='fabric.php') { ?> class="active" <?php } ?>> <a href="fabric.php">FABRICS</a></li>
				<li <?php if($_REQUEST['uniqname']==$menu_res[5]['uniqname']){?> class="active" <?php }?>><a href="page/<?php echo $menu_res[5]['uniqname']?>.html">HOW WE DO</a></li>
				<li <?php if($_REQUEST['uniqname']==$menu_res[6]['uniqname']){?> class="active" <?php }?>><a href="page/<?php echo $menu_res[6]['uniqname']?>.html">WHY CUSTOM</a></li>
				<li <?php if($_REQUEST['uniqname']==$menu_res[4]['uniqname']){?> class="active" <?php }?>><a href="page/<?php echo $menu_res[4]['uniqname']?>.html">SERVICES</a></li>
			</ul>
		</div>
	</div>
</div>
