...
if(isset($_REQUEST['submit'])) {
	...
	$result_image = $obj_db->select($sql);
	 ...
	 if(($result_image))
	 {
		 $update_string = $fit_slimfit_cond."".$fit_normalfit_cond."".$fit_loosefit_cond."".$style_fullsleeve_cond."".$style_halfsleeve_cond."".$collar_straight_cond."".$collar_englishcutaway_cond."".$collar_spread_cond."".$collar_cutaway_cond."".$collar_fullcutaway_cond."".$$fit_slimfit_cond."".$collar_curvedcutaway_cond."".$collar_cutawaybutton_cond."".$collar_bandedcollar_cond."".$collar_wingup_cond."".$collar_buttondown_cond."".$collar_rounded_cond."".$cuff_singlebuttonmiter_cond."".$cuff_doublebuttonmiter_cond."".$cuff_frenchbuttonmiter_cond."".$cuff_singlebuttonround_cond."".$cuff_doublebuttonround_cond."".$cuff_frenchbuttonsquare_cond."".$cuff_frenchbuttonround_cond."".$cuff_singlebuttonsquare_cond."".$cuff_doublebuttonsquare_cond."".$pocket_miter_cond."".$pocket_round_cond."".$pocket_square_cond."".$pocket_vshape_cond."".$pocket_nopocket_cond."".$front_placket_cond."".$front_covered_cond."".$front_noplacket_cond."".$back_sidepleats_cond."".$back_boxpleats_cond."".$back_nopleats_cond;
