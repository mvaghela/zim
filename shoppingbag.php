...
include("function/shoppingbag.php");
?>
...
<div class="topbg">
	<div class="wrapper">
		<div class="inner-title">
				<ul>
					<li class="first"><a href="#">Shopping Bag</a></li>
					<li class="last"><a href="#">Shopping Bag</a></li>
				</ul>
			</div>
	</div>
</div>	
	...
	<div class="middle">
		<div class="inner-page-left-fabric">
			...
			<table width="100%">
				<tr>
					<td colspan="3">
						<div class="login_title" style="width:50%;float:left;">
							<h1>SHOPPING BAG</h1>
						</div>
						<div class="login_title" style="float:right !important;">
							<h1>Receive it by :<?php echo (date("d-M-Y",strtotime("+10 days"))); ?></h1>
						</div>
					</td>
				</tr>
			</table>
					...
					$(function() {
					 ...
					 $('#measurement<?php echo $i?>').change(function() {
						...
						if(measure_id=='addnew'){
							 window.location = type+'_measurement.php?id='+product_id;
							 return(false);
						 }
