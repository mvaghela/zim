...
;(function (b) {
    var a = {
        init: function (c) {
            return this.each(function () {
                ...
                l.each(function (q) {
                    ...
                    n = e.attr("title");
                    n = (n != "") ? "<div>" + n + "<div class='tick_div'><img src='images/tick.png'></div></div>" : "--";
        ...
        step: function (e) {
            ...
            c.removeClass("current-step").eq(max).addClass("current-step").prev().find(".tick_div").addClass("tick_div2");
            if (this.is("form")) {
                var d = undefined;
                if (max == e) {
