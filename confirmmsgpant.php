...
$sql="INSERT INTO `cart` ( `productid`,`price`,`saveshirtcustomizeid`, `qty`,`cartsessionid`, `date`) 
		VALUES ( '".$_SESSION['productid']."','".$_SESSION['monogramprice']."','".$lastid."', '".$qty."','".$_SESSION['key']."', NOW())"; //die();
$result=$obj_db->insert($sql); 
} //die();
?>
...
-->		
			...
			<tr>
				<td colspan="2">
					<center><a href="<?php if($_SESSION['userid']!=''){?>savecustomizepants.php?productid=<?php echo $_REQUEST['id'];?>&acn=savecust<?php } else {?>login.php<?php }?>" id="login_link_h" class="login_link_h btn" style="padding: 6px 5px !important;">&nbsp; &nbsp; &nbsp; &nbsp; YES &nbsp; &nbsp; &nbsp; &nbsp;</a></center>
				</td>
				<td>
...
$_SESSION['redirecturlusedcustomize'] = 'usedcustomizepant';
...
<!--		<table>
			...
			<tr>
				<td colspan="2">
					<center><a href="<?php if($_SESSION['userid']!=''){?>savecustomizepants.php?productid=<?php echo $_REQUEST['id'];?>&acn=usedcustomizepant<?php }else {?>login.php<?php }?>" id="login_link_h" class="login_link_h btn" style="padding: 6px 5px !important;">&nbsp; &nbsp; &nbsp; &nbsp; YES &nbsp; &nbsp; &nbsp; &nbsp;</a></center>
				</td>
				<td>
					<center><a href="pantscustomize.php?productid=<?php echo $_SESSION['product'];?>" class="btn" style="padding: 6px 5px !important;" > &nbsp; &nbsp; &nbsp; &nbsp; NO &nbsp; &nbsp; &nbsp; &nbsp;</a></center>
				</td>
			</tr>
		</table>
	</div>
