	...
	<div class="middle">
		...
		<div class="inner-page-left-fabric">
			...
			<div class="filter-fabric">
				...
				<h1>Order Detail</h1>
				<h2>Order Placed : <?php echo date('d M Y'); ?></h2>
							...
							<table width="100%">
								...
								<tr>
									<td align="left" valign="top">
										<?php echo $billing_result[0]['address1'];?><br />
										<table>
											<tr>
												<td><img src="images/phone.png" /></td>
												<td><?php echo $billing_result[0]['phone'];?></td>
											</tr>
										</table>
									</td>
									<td align="left" valign="top">
										<?php echo ucfirst($billing_result[0]['payment_method']);?><br />
										<?php if($billing_result[0]['payment_method']!='paypal'){
											echo $billing_result[0]['card_number'];
										 }?>
										 <br />
										 Amount Paid : <?php echo $result_order[0]['paidamount']; ?>
									</td>
									<td align="right">
										<?php 
